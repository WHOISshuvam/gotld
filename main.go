...
func main() {
	...
	temp1, err := os.Create("temp1.txt")
	if err != nil {
		fmt.Printf("Couldnot create file.\n")
		return
	}
	defer temp1.Close()
	...
	for _, uros := range tld {
		...
		_, err = temp1.WriteString(results)
		if err != nil {
			panic(err)
		}
